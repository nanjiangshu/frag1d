 ...
 * Note that the memory of filename[] will be allocated if it is NULL
 * Usage:
 * char *filename = NULL;
 * i = option_parser_filename(argc, argv, i, &filename);
 * delete [] filename;
 ****************************************************************************/
{
    int i ; 
...
/*}}}*/
int option_parser_filename_old(int argc, char **argv, int beg, char *filename)/*{{{*/
/*****************************************************************************
 * beg is the current index of argument list, e.g., argv[i] = "--out"
 * Note that the memory of filename[] will be allocated if it is NULL
 * Usage:
