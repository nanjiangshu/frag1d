...
int main(int argc, char** argv)/*{{{*/
{
    ...
    while(i < argc)/*{{{*/
    {
        if(argv[i][0] == '-' && !isNonOptionArg) //options
        {
            ...
            {
                if( ( i = option_parser_filename_old(argc, argv, i, testIDListFile)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--train") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, trainIDListFile)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--matrix") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, submatfile)) == -1)
                    return -1;
            }
            ...
            {
                if( ( i = option_parser_filename_old(argc, argv, i, bkfreqfile)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--para") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, CParameter_conser_control)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--test-qij") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, test_Qijpath)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--train-qij") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, train_Qijpath)) == -1)
                    return -1;
            }
            ...
            {
                if( ( i = option_parser_filename_old(argc, argv, i, train_modmpath)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--test-modm") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, test_modmpath)) == -1)
                    return -1;
            }
            ...
            {
                if( ( i = option_parser_filename_old(argc, argv, i, train_fragaccpath)) == -1)
                    return -1;
            }
            else if( (strcmp(argv[i],"--test-fragacc") == 0) )  
            {
                if( ( i = option_parser_filename_old(argc, argv, i, test_fragaccpath)) == -1)
                    return -1;
            }
